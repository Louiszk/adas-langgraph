"""Framework logging configuration shared by host and sandbox entry points."""
...
def setup_logging(
    ...
    """Configure and return the root framework logger."""
...
def get_logger(name: str = "adas") -> logging.Logger:
    """Retrieve a logger under the framework namespace."""
